...
<div class="wrapper">
  ...
  <!-- Navbar <nav class="main-header navbar navbar-expand navbar-dark"> -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('class.new')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Class</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('class.all')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Classes</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('sub.all')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Subjects</p>
                </a>
              </li>
